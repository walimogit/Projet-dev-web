...
CREATE TABLE Centres(
	...
	,CONSTRAINT Centres_Personnes_FK FOREIGN KEY (ID_personnes) REFERENCES Personnes(ID_personnes)
)ENGINE=InnoDB;
...
CREATE TABLE Promotions(
        ...
        Boolsuppr                Bool NOT NULL ,
        ID_personnes             Int NOT NULL ,
        ID_personnes_Representer Int NOT NULL
	,CONSTRAINT Promotions_PK PRIMARY KEY (ID_promotion)

	,CONSTRAINT Promotions_Personnes_FK FOREIGN KEY (ID_personnes) REFERENCES Personnes(ID_personnes)
	,CONSTRAINT Promotions_Personnes0_FK FOREIGN KEY (ID_personnes_Representer) REFERENCES Personnes(ID_personnes)
)ENGINE=InnoDB;
