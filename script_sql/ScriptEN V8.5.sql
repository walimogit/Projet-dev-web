...
CREATE TABLE Enterprise(
	...
	,CONSTRAINT Enterprise_People_FK FOREIGN KEY (ID_people) REFERENCES People(ID_people)
)ENGINE=InnoDB;
...
CREATE TABLE Pilot_trust(
	...
	,CONSTRAINT Pilot_trust_People0_FK FOREIGN KEY (ID_people) REFERENCES People(ID_people)
)ENGINE=InnoDB;
...
CREATE TABLE Campus(
	...
	,CONSTRAINT Campus_City_FK FOREIGN KEY (ID_City) REFERENCES City(ID_City)
)ENGINE=InnoDB;
...
CREATE TABLE File(
        ID_Path Int  Auto_increment  NOT NULL ,
        Path    Text NOT NULL
	,CONSTRAINT File_PK PRIMARY KEY (ID_Path)
)ENGINE=InnoDB;
...
CREATE TABLE Being_located(
        ID_City       Int NOT NULL ,
        ID_enterprise Int NOT NULL
	,CONSTRAINT Being_located_PK PRIMARY KEY (ID_City,ID_enterprise)

	,CONSTRAINT Being_located_City_FK FOREIGN KEY (ID_City) REFERENCES City(ID_City)
...
CREATE TABLE Upload(
        ...
        ID_people Int NOT NULL
	,CONSTRAINT Upload_PK PRIMARY KEY (ID_Path,ID_people)

	,CONSTRAINT Upload_File_FK FOREIGN KEY (ID_Path) REFERENCES File(ID_Path)
	,CONSTRAINT Upload_People0_FK FOREIGN KEY (ID_people) REFERENCES People(ID_people)
)ENGINE=InnoDB;
