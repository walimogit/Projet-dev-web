...
CREATE TABLE Campus(
	...
	,CONSTRAINT Campus_People_FK FOREIGN KEY (ID_people) REFERENCES People(ID_people)
)ENGINE=InnoDB;
...
CREATE TABLE Class(
        ...
        Booldel             Bool NOT NULL ,
        ID_people           Int NOT NULL ,
        ID_people_Represent Int NOT NULL
	,CONSTRAINT Class_PK PRIMARY KEY (ID_class)

	,CONSTRAINT Class_People_FK FOREIGN KEY (ID_people) REFERENCES People(ID_people)
	,CONSTRAINT Class_People0_FK FOREIGN KEY (ID_people_Represent) REFERENCES People(ID_people)
)ENGINE=InnoDB;
