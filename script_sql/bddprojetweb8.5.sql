...
--
ALTER TABLE `Upload`
  ADD PRIMARY KEY (`ID_Path`,`ID_people`),
  ADD KEY `Upload_People0_FK` (`ID_people`);
...
--
ALTER TABLE `File`
  MODIFY `ID_Path` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `Upload`
  ADD CONSTRAINT `Upload_File_FK` FOREIGN KEY (`ID_Path`) REFERENCES `File` (`ID_Path`),
  ADD CONSTRAINT `Upload_People0_FK` FOREIGN KEY (`ID_people`) REFERENCES `People` (`ID_people`);
