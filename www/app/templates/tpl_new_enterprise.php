<section class="form-signin">
  ...
  <h1 class="h3 mb-3 fw-normal">Create enterprise</h1>
  <form action="new_enterprise.php" method="POST">
    ...
    <?php } ?>
    <!-- <button type="button" class="btn btn-secondary" name="BtnNewEnterprise" data-bs-dismiss="modal">Close</button> -->
    <button type="submit" name="BtnNewEnterprise" id="BtnNewEnterprise" class="btn btn-primary">Create Enterprise</button>
