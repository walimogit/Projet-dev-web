<main class="form-signin">
      <form>
        ...
        <div class="col-12">
          ...
          <input type="text" name="fisrt_name" class="form-control" id="fisrt_name" placeholder="Phillipe" required>
        </div>
        <div class="col-12">
          <label for="last_name" class="form-label">Last name</label>
          <input type="text" name="last_name" class="form-control" id="last_name" placeholder="Poutou" required>
        </div>
        <div class="col-12>
